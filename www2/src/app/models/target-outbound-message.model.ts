...
export enum TargetOutboundMessageCode {
  IN_COMPUTER_CONNECTED = 0x30,
  IN_COMPUTER_START_CALIBRATION = 0x31,
  IN_COMPUTER_CHANGE_TOLERANCE = 0x32,
  IN_COMPUTER_ENABLE_BUMPER = 0x33,
  IN_COMPUTER_ENABLE_BUMPERS = 0x34,
  IN_COMPUTER_DISABLE_BUMPER = 0x35,
  IN_COMPUTER_DISABLE_BUMPER_AND_BLINK = 0x36,
  IN_COMPUTER_DISABLE_BUMPERS_AND_BLINK = 0x37,
  IN_COMPUTER_GET_STATE = 0x38,
  IN_COMPUTER_RESET = 0x3F
}
