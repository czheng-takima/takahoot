...
export enum OutCode {
  OUT_COMPUTER_CONNECTED = 0x80,
  OUT_COMPUTER_CALIBRATION_STARTED = 0x81,
  OUT_COMPUTER_CALIBRATION_FINISHED = 0x82,
  OUT_COMPUTER_BUMPER_HIT = 0x84,
  OUT_COMPUTER_CONTROLLER_STATE = 0x88
}
